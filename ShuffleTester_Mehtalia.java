 ...
 */
public class ShuffleTester_Mehtalia {
    ...
    /**The shuffle method can only work for deck 3, which has the 52 cards
    required for running this method. All other methods would create an 
    error, and since the method is required to run for 52 cards, 
    it can only do so for deck 3
    
    */
    
    d3.shuffle();
    
    //Printing out all the cards of deck 3, shuffled
    
    System.out.println("All the cards of deck 3 after shuffling: ");
    System.out.println(d3);
    

    //Method testing
    
    System.out.println("Now to test all the methods of the deck and card classes");
    System.out.println("");
 ...
 * @return the number of undealt cards in this deck.
 ...
 //Using the efficient selection shuffle, the third way given.
