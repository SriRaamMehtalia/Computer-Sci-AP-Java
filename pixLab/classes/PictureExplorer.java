 ...
 */
public class PictureExplorer_Mehtalia implements MouseMotionListener, ActionListener, MouseListener
{
   ...
   */
  public PictureExplorer_Mehtalia(DigitalPicture picture)
  {
    // set the fields
  ...
  private void createAndInitPictureFrame()
  {
    ...
    PictureExplorer_MehtaliaFocusTraversalPolicy newPolicy = new PictureExplorer_MehtaliaFocusTraversalPolicy();
   ...
   */
  private class PictureExplorer_MehtaliaFocusTraversalPolicy
  ...
  {
    Picture image = new Picture("533.jpg");
    Picture smallP = image.scale(0.25,0.25);
    //Scales image down 1.4 size
    smallP.explore();
  }
